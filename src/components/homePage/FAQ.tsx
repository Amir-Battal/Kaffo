    ...
    <div id="faq" dir="rtl" className="w-full px-40 pt-40 flex flex-col gap-5">
      ...
      <div>
        ...
        <AccordionItem value="item-6">
          ...
          <AccordionContent className="text-[15px]">
            عند تقديم التبرع لحل مشكلة معينة فإن القائمين على حل المشكلة سوف يقومون برفع مراحل حل المشكلة واحدة تلو الآخرى مرفقة بالصور وشرح المصروفات وكيفية العمل على حل المشكلة
          </AccordionContent>
        </AccordionItem>
      </Accordion>
      </div>
