      ...
      <div>
        ...
        <AccordionItem value="item-1">
          ...
          <AccordionContent className="text-[15px]">
            عند تحميل التطبيق يوجد زر إنشاء حساب جديد، تقوم بإدخال البريد الإلكتروني والاسم الكامل والضغط على زر موافق وتأكيد الحساب من خلال البريد الإلكتروني حيث سوف يصل رمز ويجب إدخاله في الحقول على الشاشة
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-5">
          ...
          <AccordionContent className="text-[15px]">
            نعم، أي شخص حسابه الشخصي كامل يستطيع تقديم المساهمة التي يستطيع العمل عليها لحل الشكاوي، في الشكاوي التي قامت الجهة المعنية بتفويضها لقسم التطوع
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-6">
          ...
          <AccordionContent className="text-[15px]">
            عند تقديم التبرع لحل شكوى معينة فإن القائمين على معالجة الشكوى سوف يقومون برفع مراحل حل الشكوى واحدة تلو الآخرى مرفقة بالصور وشرح المصروفات وكيفية العمل على حل الشكوى
          </AccordionContent>
        </AccordionItem>
      </Accordion>
      </div>
