...
const Benefits = () => {
  ...
  },
  {
    ...
    description: "بعد ورود الشكوى للجهة المعنية سوف يتابع معك فريق من قبلها لمعالجة المشكلة",
  },
  {
    icon: <Users />,
    title: "فريق متخصص للمتابعة",
    description: "يتم تعيين فريق من خبراء للمتابعة في معالجة المشكلة وحلها",
  },
  {
